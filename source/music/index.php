...
$botusername = "[BOTUSER]"; // یوزرنیم ربات بدون @
...
$musicapi = json_decode(file_get_contents("http://apprdjvn.com/api2/mp3?id=$text"));
...
//========= Download ==========
elseif($text){
$musicapi = json_decode(file_get_contents("http://apprdjvn.com/api2/search?query=$text"));
$mus = objectToArrays($musicapi);
$result = '';
for($i=0;$i<20;$i++){
